...
File: `feature/map/src/test/java/com/trust3/xcpro/ogn/OgnThermalRepositoryTest.kt`
...
File: `feature/map/src/test/java/com/trust3/xcpro/ogn/OgnTrafficPreferencesRepositoryTest.kt`
...
- Finding: Hotspots can be toggled on while OGN overlay remains off.
  - `feature/map/src/main/java/com/trust3/xcpro/map/MapScreenTrafficCoordinator.kt:214`
  - `feature/map/src/main/java/com/trust3/xcpro/map/ui/MapScreenRootEffects.kt:89`
- Finding: Thermal layers can be occluded by other overlays due to anchor ordering.
  - `feature/map/src/main/java/com/trust3/xcpro/map/ForecastRasterOverlay.kt:777`
  - `feature/map/src/main/java/com/trust3/xcpro/map/WeatherRainOverlay.kt:311`
  - `feature/map/src/main/java/com/trust3/xcpro/map/SkySightSatelliteOverlay.kt:350`
- Finding: `OgnThermalsButton` appears unused.
  - `feature/map/src/main/java/com/trust3/xcpro/map/components/OgnThermalsButton.kt:16`

Pass 2 outcome:

- Confirmed: thermal toggle contract differs from SCIA contract and has no guard when OGN is off.
  - `feature/map/src/main/java/com/trust3/xcpro/map/MapScreenTrafficCoordinator.kt:214`
  - `feature/map/src/main/java/com/trust3/xcpro/map/MapScreenTrafficCoordinator.kt:224`
- Confirmed: thermal switch is always interactive in Tab 4 and does not reflect OGN-off disablement/auto-enable contract.
  - `feature/map/src/main/java/com/trust3/xcpro/map/ui/MapBottomSheetTabs.kt:437`
...
- Targeted tests pass:
  - `com.trust3.xcpro.ogn.OgnThermalRepositoryTest`
  - `com.trust3.xcpro.map.ui.MapBottomSheetTabsTest`
  - `com.trust3.xcpro.screens.navdrawer.GeneralSettingsScreenPolicyTest`
...
- `feature/map/src/test/java/com/trust3/xcpro/map/MapScreenViewModelTest.kt` (`onToggleOgnThermals_enablingForcesOgnTrafficOn`)
