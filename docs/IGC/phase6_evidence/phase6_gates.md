...
- Command: `./gradlew --no-daemon --no-configuration-cache "-Pksp.incremental=false" :feature:map:testDebugUnitTest --tests "com.trust3.xcpro.igc.usecase.IgcRecoveryBootstrapUseCaseTest"`
- Result: PASS
- Command: `./gradlew --no-daemon --no-configuration-cache "-Pksp.incremental=false" :app:testDebugUnitTest --tests "com.trust3.xcpro.igc.AppIgcRecoveryDiagnosticsReporterTest"`
- Result: PASS
...
- Command: `$env:ANDROID_SERIAL="R5CT2084XHN"; ./gradlew --no-daemon --no-configuration-cache "-Pksp.incremental=false" "-Pandroid.testInstrumentationRunnerArguments.class=com.trust3.xcpro.igc.IgcRecoveryRestartInstrumentedTest" :feature:igc:connectedDebugAndroidTest --no-parallel`
- Result: PASS
...
- Fix applied:
  ...
  - new path: `feature/igc/src/androidTest/java/com/trust3/xcpro/screens/replay/IgcFilesShareIntentsInstrumentedTest.kt`
- Attempt 2:
