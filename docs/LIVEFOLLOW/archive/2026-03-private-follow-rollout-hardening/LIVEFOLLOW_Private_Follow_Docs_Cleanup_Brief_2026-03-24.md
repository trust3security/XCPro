...
- use `README_current.md` for the current canon
...
- make `README_current.md` the reliable entrypoint again
...
Preferred rule:
- keep it active only if it still contains current environment/setup requirements that are not already captured clearly in `Private_Follow_Current_Repo_State_2026-03-24.md` or `README_current.md`
...
## Task 4 — Rewrite `README_current.md`
Rewrite `README_current.md` so the current docs are easy to navigate again.
...
- fix any broken links or references in `README_current.md`
...
- `README_current.md` clearly separates public canon from private-follow canon
