...
3. Run C: residual SI contract normalization (radius contracts, interactive distance contracts, scoring speed contracts).
4. Run D: compliance closeout (adapter tests, deep re-pass, docs sync, final verification).
...
2. Internal `*Km` wrappers in coordinator/use-case/viewmodel/manager surfaces are removed or boundary-justified.
3. Required verification commands in Section 4 pass.
