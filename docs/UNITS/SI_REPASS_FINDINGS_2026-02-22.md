...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingGeometryUtils.kt`
...
- `feature/map/src/test/java/com/example/xcpro/replay/ReplayRuntimeInterpolatorTest.kt`
- `feature/map/src/test/java/com/example/xcpro/replay/ReplayHeadingResolverTest.kt`
...
- `feature/map/src/main/java/com/example/xcpro/map/DistanceCirclesCanvas.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/CommonTaskComponents.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/ui/RacingTurnPointSelector.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/ManageBTTabRouter.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingManageBTTab.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATManageContent.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATManageBTTab.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingWaypointList.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingWaypointListItems.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/ui/RacingTaskPointTypeSelector.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATValidationBridge.kt:175`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/rendering/AATTaskRenderer.kt:162`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/rendering/AATTaskRenderer.kt:168`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/rendering/AATTaskRenderer.kt:185`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/geometry/AATGeometryGenerator.kt:184`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskManager.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskTypeCoordinatorDelegate.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/AATCoordinatorDelegate.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/RacingCoordinatorDelegate.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskManagerCoordinator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskSheetCoordinatorUseCase.kt`
- `feature/map/src/test/java/com/example/xcpro/tasks/TaskManagerCoordinatorTest.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskManager.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskValidator.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/boundary/RacingBoundaryCrossingPlanner.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/boundary/RacingBoundaryCrossingMath.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/TurnPointInterfaces.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/CylinderCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/KeyholeCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/FAIQuadrantCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/StartLineCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/StartLineDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/FinishLineDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/CylinderDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/KeyholeDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/FAIQuadrantDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/turnpoints/FAIStartSectorDisplay.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingGeometryCoordinator.kt`
...
- `feature/map/src/test/java/com/example/xcpro/tasks/racing/RacingGeometryUtilsTest.kt`
- `feature/map/src/test/java/com/example/xcpro/tasks/racing/boundary/RacingBoundaryCrossingPlannerTest.kt`
- `feature/map/src/test/java/com/example/xcpro/tasks/TaskManagerCoordinatorTest.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/core/Models.kt:29`
- `feature/map/src/main/java/com/example/xcpro/tasks/core/Models.kt:33`
- `feature/map/src/main/java/com/example/xcpro/tasks/domain/engine/AATTaskWaypointCodec.kt:38`
- `feature/map/src/main/java/com/example/xcpro/tasks/domain/engine/AATTaskWaypointCodec.kt:69`
- `feature/map/src/main/java/com/example/xcpro/tasks/domain/engine/DefaultRacingTaskEngine.kt:142`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATMathUtils.kt:16`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATMathUtils.kt:32`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATMathUtils.kt:54`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/geometry/AATGeometryGenerator.kt:30`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/geometry/AATGeometryGenerator.kt:33`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/gestures/AatGestureHandler.kt:28`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/map/AATEditModeState.kt:56`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/map/AATEditModeState.kt:148`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/map/AATAreaTapDetector.kt:21`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/map/AATMovablePointStrategySupport.kt:18`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/interaction/AATEditGeometry.kt:17`

### 4) Observation-zone resolver still starts from km radius fields
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskObservationZoneResolver.kt:88`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskObservationZoneResolver.kt:93`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskObservationZoneResolver.kt:133`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskObservationZoneResolver.kt:136`

### 5) Residual ad-hoc racing km->m conversions remain
- `feature/map/src/main/java/com/example/xcpro/map/replay/RacingReplayAnchorBuilder.kt:177`
- `feature/map/src/main/java/com/example/xcpro/map/replay/RacingReplayAnchorBuilder.kt:251`
- `feature/map/src/main/java/com/example/xcpro/map/replay/RacingReplayAnchorBuilder.kt:268`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskManagerCoordinator.kt:258`

### 6) OGN policy/helper layer remains km-first
- `feature/map/src/main/java/com/example/xcpro/ogn/OgnSubscriptionPolicy.kt:24`
- `feature/map/src/main/java/com/example/xcpro/ogn/OgnTrafficRepository.kt:412`
- `feature/map/src/main/java/com/example/xcpro/ogn/OgnTrafficRepository.kt:564`
- `feature/map/src/main/java/com/example/xcpro/ogn/OgnGliderTrailRepository.kt:130`

### 7) Minor correctness cleanup still needed
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/map/AATEditModeState.kt:60`

`0.00001` km is approximately 1 cm, while comment claims approximately 1 meter.

### 8) Legacy dead helper still present
- `feature/map/src/main/java/com/example/xcpro/gestures/AirspaceGestureMath.kt:9`
...
- `feature/map/src/main/java/com/example/xcpro/ogn/OgnSubscriptionPolicy.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATTaskSafetyValidator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATFlightPathValidator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/CircleAreaCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/SectorAreaCalculator.kt`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/SectorAreaGeometrySupport.kt`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATRadiusAuthority.kt:41`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATRadiusAuthority.kt:146`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATRadiusAuthority.kt:197`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATRadiusAuthority.kt:238`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskManager.kt:104`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskManager.kt:105`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/core/Models.kt:29`
- `feature/map/src/main/java/com/example/xcpro/tasks/core/Models.kt:39`
- `feature/map/src/main/java/com/example/xcpro/tasks/core/TaskWaypointCustomParams.kt:147`
- `feature/map/src/main/java/com/example/xcpro/tasks/core/TaskWaypointCustomParams.kt:167`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/models/RacingWaypoint.kt:19`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/models/RacingWaypoint.kt:21`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/models/RacingWaypoint.kt:24`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskManager.kt:144`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskManager.kt:146`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskManager.kt:295`
- `feature/map/src/main/java/com/example/xcpro/tasks/domain/engine/DefaultAATTaskEngine.kt:186`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskManager.kt:111`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskManager.kt:290`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATGeoMath.kt:32`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATGeoMath.kt:56`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATInteractiveDistanceCalculator.kt:77`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATInteractiveDistanceCalculator.kt:140`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATInteractiveModels.kt:9`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATInteractiveModels.kt:31`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATSpeedCalculator.kt:25`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATSpeedCalculator.kt:32`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/calculations/AATSpeedCalculator.kt:223`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATResult.kt:17`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATResult.kt:197`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskManagerCoordinator.kt:221`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskSheetCoordinatorUseCase.kt:73`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskSheetViewModel.kt:124`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskTypeCoordinatorDelegate.kt:21`
- `feature/map/src/main/java/com/example/xcpro/tasks/TaskTypeCoordinatorDelegate.kt:26`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskCalculator.kt:202`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskCalculator.kt:217`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskCalculator.kt:222`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskCalculator.kt:224`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskCalculator.kt:239`
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingTaskCalculator.kt:244`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATWaypoint.kt:54`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATWaypoint.kt:55`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATWaypoint.kt:62`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATWaypoint.kt:64`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceRules.kt:16`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceRules.kt:71`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceRules.kt:76`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceAreaRules.kt:123`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATTaskStrategicValidator.kt:16`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATTaskStrategicValidator.kt:24`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATValidationScoreCalculator.kt:29`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATValidationScoreCalculator.kt:41`
- `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATCompetitionComplianceEvaluator.kt:22`
...
- `feature/map/src/main/java/com/example/xcpro/tasks/racing/models/RacingTaskResultModels.kt:16`
...
3. `AATWaypoint` target-offset contract is meter-canonical:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/models/AATWaypoint.kt`
4. AAT competition validation/scoring internals are SI-first (meters/m2/m/s) with km/km/h text only at output formatting:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceRules.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/FAIComplianceAreaRules.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATTaskStrategicValidator.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATValidationScoreCalculator.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/validation/AATCompetitionComplianceEvaluator.kt`
5. Racing result speed contract is SI-native:
   - `feature/map/src/main/java/com/example/xcpro/tasks/racing/models/RacingTaskResultModels.kt` (`averageSpeedMs`)
...
2. Legacy/dead km helper cleanup still pending (`#34` and `#28`):
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/AreaBoundaryCalculator.kt` (km-returning helper path)
   - `feature/map/src/main/java/com/example/xcpro/tasks/KeyholeVerification.kt` (legacy helper)
   - `feature/map/src/main/java/com/example/xcpro/gestures/AirspaceGestureMath.kt` (unused helper)
...
1. Polar model/config contracts are now SI-canonical in storage and internal runtime usage:
   ...
   - `core/common/src/main/java/com/example/xcpro/common/glider/GliderConfigModels.kt`
2. Polar interpolation and bounds internals are SI-only (`m/s`), with km/h only at explicit conversion boundaries:
   ...
   - `feature/map/src/main/java/com/example/xcpro/glider/GliderSpeedBounds.kt`
...
5. Added regression coverage for migration/parity:
   - `feature/map/src/test/java/com/example/xcpro/glider/GliderRepositorySiMigrationTest.kt`
   - `feature/map/src/test/java/com/example/xcpro/glider/PolarCalculatorSiContractTest.kt`
   - `feature/map/src/test/java/com/example/xcpro/glider/GliderSpeedBoundsResolverSiContractTest.kt`
...
1. PASS:
   - `:feature:map:testDebugUnitTest --tests "com.example.xcpro.glider.*"`
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/gestures/AatGestureHandler.kt` still references `resolvedCustomRadiusKm()` for AAT edit-mode callback compatibility.
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/gestures/AatGestureHandler.kt` still calls `resolvedCustomRadiusKm()` for edit-mode callback compatibility.
...
1. Racing UI still reads the legacy km radius field in an active internal state key path:
   - `feature/map/src/main/java/com/example/xcpro/tasks/racing/RacingWaypointListItems.kt` (`taskWaypoint.customRadius` in `remember(...)` keys)
...
1. ADS-B boundary adapter coverage added:
   ...
   - OpenSky HTTP boundary serialization/auth header assertions:
     - `feature/map/src/test/java/com/example/xcpro/adsb/OpenSkyProviderClientTest.kt`
...
3. Replay boundary adapter coverage added:
   ...
   - synthetic replay speed conversion + step quantization:
     - `feature/map/src/test/java/com/example/xcpro/map/replay/RacingReplayLogBuilderTest.kt`

### Verification Snapshot (Run 24)
1. PASS:
   - `./gradlew --no-daemon --no-configuration-cache :feature:map:testDebugUnitTest --tests "com.example.xcpro.adsb.OpenSkyProviderClientTest" --tests "com.example.xcpro.adsb.AdsbTrafficRepositoryTest" --tests "com.example.xcpro.ogn.OgnTrafficRepositoryPolicyTest" --tests "com.example.xcpro.ogn.OgnTrafficRepositoryConnectionTest" --tests "com.example.xcpro.replay.ReplaySampleEmitterTest" --tests "com.example.xcpro.map.replay.RacingReplayLogBuilderTest"`
...
2. `#34` unresolved target 1:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/AreaBoundaryCalculator.kt`
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/ui/AATLongPressOverlay.kt`
   - local km haversine helper and meter-to-km conversion in hit-test logic; file appears unused (no call sites found).
2. `feature/map/src/main/java/com/example/xcpro/tasks/aat/interaction/AATEditGeometry.kt`
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/AreaBoundaryCalculator.kt`
   - `calculateAreaSizeKm2(...)` is actively consumed by `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskQuickValidationEngine.kt`.
2. `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskQuickValidationEngine.kt`
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/interaction/AATEditGeometry.kt`
...
1. `#28` unresolved:
   - `feature/map/src/main/java/com/example/xcpro/gestures/AirspaceGestureMath.kt`
2. `#34` unresolved:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/AreaBoundaryCalculator.kt` (`calculateDistanceInArea(...)`)
   - `feature/map/src/main/java/com/example/xcpro/tasks/KeyholeVerification.kt`
3. Adjacent unresolved:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/ui/AATLongPressOverlay.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/interaction/AATEditGeometry.kt` km wrapper set
...
1. Active km2 helper chain includes:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/CircleAreaCalculator.kt` (`calculateAreaSizeKm2(...)`)
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/SectorAreaCalculator.kt` (`calculateAreaSizeKm2(...)`)
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/SectorAreaGeometrySupport.kt` (`calculateAreaSizeKm2(...)`)
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/areas/AreaBoundaryCalculator.kt` (`calculateAreaSizeKm2(...)`)
2. Consumption path remains active:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/AATTaskQuickValidationEngine.kt` (`areaSizeKm2` thresholds + warning strings)
...
3. Adjacent unresolved wrappers:
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/ui/AATLongPressOverlay.kt`
   - `feature/map/src/main/java/com/example/xcpro/tasks/aat/interaction/AATEditGeometry.kt`
...
1. `feature/map/src/test/java/com/example/xcpro/tasks/aat/AATTaskQuickValidationEngineUnitsTest.kt`
...
1. `feature/map/src/main/java/com/example/xcpro/tasks/aat/geometry/AATGeometryGenerator.kt`
...
### Closures
1. `#28` closed:
   - removed `feature/map/src/main/java/com/example/xcpro/gestures/AirspaceGestureMath.kt`.
2. `#34` closed:
   - removed dead `AreaBoundaryCalculator.calculateDistanceInArea(...)`,
   - removed commented `feature/map/src/main/java/com/example/xcpro/tasks/KeyholeVerification.kt`,
...
1. PASS:
   - `./gradlew :feature:map:testDebugUnitTest --tests "com.example.xcpro.tasks.aat.AATTaskQuickValidationEngineUnitsTest" --no-daemon --no-configuration-cache`
2. PASS:
