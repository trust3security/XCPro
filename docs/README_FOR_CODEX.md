...
6. **NETTO_SETTINGS_S100_PARITY.md**  
   - Pilot-facing settings semantics  
   - How domain logic responds to settings

7. **PHASED_IMPLEMENTATION_WIND_TAS_IAS_NETTO.md**  
   - Step-by-step execution plan  
   - What to implement in each phase  
   - Required tests per phase

8. **GOLDEN_REPLAY_TEST_PLAN.md**  
   - Deterministic replay regression gates  
   - Anti-flicker and honesty checks
