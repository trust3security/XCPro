...
- Evidence:
  ...
  - `feature/map/src/main/java/com/example/xcpro/map/LocationManager.kt:215`
  - `feature/map/src/main/java/com/example/xcpro/map/DisplayPoseRenderCoordinator.kt:49`
  - `feature/map/src/main/java/com/example/xcpro/map/MapTrackingCameraController.kt:53`
  - `feature/map/src/main/java/com/example/xcpro/map/MapPositionController.kt:44`
  - `feature/map/src/main/java/com/example/xcpro/map/BlueLocationOverlay.kt:110`
...
- Evidence:
  ...
  - `feature/map/src/main/java/com/example/xcpro/sensors/SensorRegistry.kt:285`
  - `feature/map/src/main/java/com/example/xcpro/sensors/SensorRegistry.kt:300`
  - `feature/map/src/main/java/com/example/xcpro/sensors/SensorRegistry.kt:314`
  - `feature/map/src/main/java/com/example/xcpro/vario/VarioServiceManager.kt:45`
  - `feature/map/src/main/java/com/example/xcpro/vario/GpsCadencePolicy.kt:11`
...
- Evidence:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:147`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:44`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:55`
...
- Evidence:
  - `feature/map/src/main/java/com/example/xcpro/audio/VarioAudioController.kt:44`
  - `feature/map/src/main/java/com/example/xcpro/audio/VarioBeepController.kt:25`
  - `feature/map/src/main/java/com/example/xcpro/audio/VarioToneGenerator.kt:36`
...
- Evidence:
  ...
  - `feature/map/src/main/java/com/example/xcpro/map/MapOverlayManager.kt:373`
  - `feature/map/src/main/java/com/example/xcpro/map/OgnTrafficOverlay.kt:102`
  - `feature/map/src/main/java/com/example/xcpro/map/OgnThermalOverlay.kt:64`
  - `feature/map/src/main/java/com/example/xcpro/map/OgnGliderTrailOverlay.kt:58`
...
- Evidence:
  ...
  - `feature/map/src/main/java/com/example/xcpro/map/AdsbTrafficOverlay.kt:254`
  - `feature/map/src/main/java/com/example/xcpro/map/AdsbDisplayMotionSmoother.kt:62`
...
- Evidence:
  - `feature/map/src/main/java/com/example/xcpro/map/trail/SnailTrailManager.kt:95`
  - `feature/map/src/main/java/com/example/xcpro/map/trail/SnailTrailOverlay.kt:243`
  - `feature/map/src/main/java/com/example/xcpro/map/trail/SnailTrailOverlay.kt:291`
...
- Evidence:
  - `feature/map/src/main/java/com/example/xcpro/weather/rain/ObserveWeatherOverlayStateUseCase.kt:42`
  - `feature/map/src/main/java/com/example/xcpro/weather/rain/ObserveWeatherOverlayStateUseCase.kt:70`
  - `feature/map/src/main/java/com/example/xcpro/weather/rain/WeatherOverlaySettings.kt:16`
  - `feature/map/src/main/java/com/example/xcpro/map/WeatherRainOverlay.kt:118`
...
- Evidence:
  - `feature/map/src/main/java/com/example/xcpro/map/SkySightSatelliteOverlay.kt:44`
  - `feature/map/src/main/java/com/example/xcpro/map/SkySightSatelliteOverlay.kt:90`
  - `feature/map/src/main/java/com/example/xcpro/map/SkySightSatelliteOverlay.kt:205`
  - `feature/map/src/main/java/com/example/xcpro/map/SkySightSatelliteOverlay.kt:328`
...
- OGN overlay default off:
  - `feature/map/src/main/java/com/example/xcpro/ogn/OgnTrafficPreferencesRepository.kt:39`
- ADS-B overlay default off:
  - `feature/map/src/main/java/com/example/xcpro/adsb/AdsbTrafficPreferencesRepository.kt:33`
- Weather rain overlay default off:
  - `feature/map/src/main/java/com/example/xcpro/weather/rain/WeatherOverlayPreferencesRepository.kt:124`
