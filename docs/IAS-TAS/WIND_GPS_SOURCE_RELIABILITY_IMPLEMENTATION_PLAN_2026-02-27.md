...
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/` (new debug policy/metrics helper if needed)
...
Primary files:
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt` (new)
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt`
...
Primary files:
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/AirspeedSourceStabilityController.kt` (new)
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt`
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/FusionBlackboard.kt` (if shared state storage is preferred)
...
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/AirspeedModels.kt` (only if metadata extension is needed)
...
- `feature/map/src/test/java/com/example/xcpro/sensors/domain/` (new policy/controller tests)
...
Primary files:
- `feature/map/src/main/java/com/example/xcpro/sensors/domain/FlightMetricsConstants.kt` (or policy config holder)
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/vario/VarioServiceManager.kt:49`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:152`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:167`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:67`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:124`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:126`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/model/WindState.kt:9`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:321`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:317`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/SpeedToFlyCalculator.kt:69`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:69`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:398`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:467`
  - `feature/map/src/main/java/com/example/xcpro/sensors/SensorData.kt:38`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightStateRepository.kt:69`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightStateRepository.kt:106`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/FlyingStateDetector.kt:41`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:81`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:83`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:140`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:194`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/FusionBlackboard.kt:67`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:69`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:399`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:21`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:467`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/SensorData.kt:20`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:110`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindEstimator.kt:17`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindOverrideRepository.kt:70`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindOverrideRepository.kt:98`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:266`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:82`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:141`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:196`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:308`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:395`
  - `feature/map/src/test/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCaseTest.kt:406`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/FlightMetricsConstants.kt:22`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightCalculationHelpers.kt:58`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/domain/WindSelectionUseCase.kt:24`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/domain/WindSelectionUseCase.kt:25`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:377`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:47`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:52`
  - `feature/map/src/test/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicyTest.kt:67`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:81`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:82`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:191`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngine.kt:224`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:141`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:174`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataCalculatorEngineLoops.kt:293`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataEmitter.kt:152`
  - `feature/map/src/main/java/com/example/xcpro/sensors/FlightDataEmitter.kt:177`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:100`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:104`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:124`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:124`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:274`
  - `feature/map/src/main/java/com/example/xcpro/flightdata/FlightDisplayMapper.kt:83`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/model/WindState.kt:11`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:45`
  - `dfcards-library/src/main/java/com/example/dfcards/FlightDataSources.kt:63`
  - `feature/map/src/main/java/com/example/xcpro/map/MapScreenObservers.kt:192`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/map/FlightDataManager.kt:42`
  - `feature/map/src/main/java/com/example/xcpro/MapScreenUtils.kt:72`
  - `dfcards-library/src/main/java/com/example/dfcards/CardFormatSpec.kt:415`
  - `feature/map/src/main/java/com/example/xcpro/map/trail/domain/TrailProcessor.kt:166`
  - `feature/map/src/main/java/com/example/xcpro/map/ui/OverlayPanels.kt:195`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/MapScreenUtils.kt:72`
  - `feature/map/src/main/java/com/example/xcpro/MapScreenUtils.kt:79`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:45`
...
- References:
  - `feature/map/src/test/java/com/example/xcpro/ConvertToRealTimeFlightDataTest.kt:112`
  - `feature/map/src/test/java/com/example/xcpro/map/trail/TrailProcessorTest.kt:22`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:96`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/CalculateFlightMetricsUseCase.kt:124`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/FlightMetricsConstants.kt:26`
  - `feature/map/src/main/java/com/example/xcpro/sensors/domain/WindAirspeedEligibilityPolicy.kt:19`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:225`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:239`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:257`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/domain/WindSelectionUseCase.kt:23`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindOverrideRepository.kt:44`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:171`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:257`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:141`
...
- References:
  - `feature/map/src/test/java/com/example/xcpro/weather/wind/WindSelectionUseCaseTest.kt:15`
...
- References:
  ...
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:339`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:364`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:376`
...
- References:
  ...
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindOverrideRepository.kt:95`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindOverrideRepository.kt:111`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/ExternalAirspeedRepository.kt:16`
...
- References:
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:107`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:118`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:176`
  - `feature/map/src/main/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepository.kt:225`
...
- References:
  - `feature/map/src/test/java/com/example/xcpro/weather/wind/WindSelectionUseCaseTest.kt:15`
  - `feature/map/src/test/java/com/example/xcpro/weather/wind/data/WindSensorFusionRepositoryTest.kt:27`
  - `feature/map/src/test/java/com/example/xcpro/weather/wind/WindSensorFusionRepositoryTest.kt:44`
