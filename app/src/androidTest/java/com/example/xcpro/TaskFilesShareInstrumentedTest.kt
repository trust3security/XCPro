...
import com.example.xcpro.tasks.ShareRequest
import com.example.xcpro.tasks.shareRequest
...
class TaskFilesShareInstrumentedTest {
    ...
    fun multiDocumentShareUsesSingleChooserSendMultipleIntent() {
        ...
        val jsonUri = "content://com.example.xcpro.test.provider/cache/task_1.xcp.json"
        val cupUri = "content://com.example.xcpro.test.provider/cache/task_1.cup"
