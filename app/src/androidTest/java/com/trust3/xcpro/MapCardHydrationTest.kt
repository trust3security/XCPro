...
import com.trust3.xcpro.map.CardIngestionCoordinator
...
class MapCardHydrationTest {
    ...
    fun cardsHydrateWhenLiveDataArrivesOnMapFirstLaunch() = runBlocking {
        ...
        val flightDataManager = FlightDataManager(testScope)
        val flightCardSessionBinder = FlightCardSessionBinder(cardPreferences)
        ...
        val ingestionCoordinator = CardIngestionCoordinator(
            ...
            unitsPreferencesFlow = flightDataManager.unitsPreferencesFlow,
