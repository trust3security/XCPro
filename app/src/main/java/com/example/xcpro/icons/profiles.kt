...
val DFUsers: ImageVector by lazy {
    createIcon(
        name = "DFUsers",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(
            ...
            curveTo(6.29353f, 21f, 4.11264f, 20.3552f, 2.25092f, 19.2343f)
            curveTo(2.25031f, 19.198f, 2.25f, 19.1615f, 2.25f, 19.125f)
            curveTo(2.25f, 15.6042f, 5.10418f, 12.75f, 8.625f, 12.75f)
            curveTo(11.0329f, 12.75f, 13.129f, 14.085f, 14.2136f, 16.0552f)
            moveTo(12f, 6.375f)
            curveTo(12f, 8.23896f, 10.489f, 9.75f, 8.625f, 9.75f)
            curveTo(6.76104f, 9.75f, 5.25f, 8.23896f, 5.25f, 6.375f)
            curveTo(5.25f, 4.51104f, 6.76104f, 3f, 8.625f, 3f)
            curveTo(10.489f, 3f, 12f, 4.51104f, 12f, 6.375f)
            close()
            ...
            curveTo(15f, 7.17525f, 16.1753f, 6f, 17.625f, 6f)
            curveTo(19.0747f, 6f, 20.25f, 7.17525f, 20.25f, 8.625f)
            close()
        }
    }
}