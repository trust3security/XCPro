...
data class PolarCoefficients(
    ...
    val b: Double?,
    val c: Double?,
    // Valid speed range in km/h for which coefficients apply
...
data class GliderModel(
    val id: String,
    val name: String,
    val classLabel: String, // e.g., "18m", "21m"
...
// Initial presets; polar coefficients/points to be refined from manufacturer data
fun defaultGliderModels(): List<GliderModel> = listOf(
    ...
    GliderModel(
        ...
        name = "ASG-29 (18m)",
        classLabel = "18m",
        // Placeholder metadata; polar to be populated
        polar = null,
        points = null
    ),
    GliderModel(
