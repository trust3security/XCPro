...
// Home Waypoint Utility Functions
...
// --- Lightweight wrapper for search UI ---
data class SearchWaypoint(
    val id: String,
    val title: String,      // e.g. "Omarama Airfield (OMR)"
    val subtitle: String,   // e.g. "✈️  -44.4870, 169.9690"
    val lat: Double,
    val lon: Double
)


// --- Adapter: convert real WaypointData → SearchWaypoint ---
fun WaypointData.toSearchWaypoint(): SearchWaypoint {
