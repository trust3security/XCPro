...
internal fun GeneralSettingsSubSheetContent(
    ...
    when (activeSubSheet) {
        ...
        GeneralSubSheet.WEATHER -> WeatherSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToMap = onNavigateToMap
        )
        GeneralSubSheet.FILES -> FilesSettingsSubSheet(
        ...
        GeneralSubSheet.PROFILES -> ProfilesSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.LOOK_AND_FEEL -> LookAndFeelSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.UNITS -> UnitsSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.POLAR -> PolarSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.LEVO_VARIO -> LevoVarioSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.HAWK_VARIO -> HawkVarioSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.SKYSIGHT -> ForecastSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.OGN -> OgnSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
            onNavigateToMap = onNavigateToMap
        )
        GeneralSubSheet.WEGLIDE -> WeGlideSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
            onNavigateToMap = onNavigateToMap
        )
        ...
        GeneralSubSheet.HOTSPOTS -> HotspotsSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
            onNavigateToMap = onNavigateToMap
        )
        GeneralSubSheet.NAVBOXES -> NavboxesSettingsSubSheet(
            navController = navController,
            drawerState = drawerState,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
        ...
        GeneralSubSheet.IGC_REPLAY -> IgcFilesSettingsSubSheet(
            navController = navController,
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) }
        )
        GeneralSubSheet.ORIENTATION -> OrientationSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
            onNavigateToMap = onNavigateToMap
        )
        GeneralSubSheet.THERMALLING -> ThermallingSettingsSubSheet(
            onDismiss = { onSubSheetChange(GeneralSubSheet.NONE) },
            onNavigateToDrawer = onNavigateToDrawer,
            onNavigateToMap = onNavigateToMap
        )
