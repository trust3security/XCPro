...
import com.trust3.xcpro.appshell.settings.GeneralSettingsSheetHost
import com.trust3.xcpro.appshell.settings.consumeOpenGeneralSettingsOnMap
import com.trust3.xcpro.map.MapScreenViewModel
import com.trust3.xcpro.map.ui.MapScreen
...
internal fun SharedMapRouteHost(
    ...
    val openGeneralSettingsOnMap by viewModelOwnerEntry.savedStateHandle
        .getStateFlow(
            com.trust3.xcpro.navigation.MapNavigationSignals.OPEN_GENERAL_SETTINGS_ON_MAP,
            false
        )
