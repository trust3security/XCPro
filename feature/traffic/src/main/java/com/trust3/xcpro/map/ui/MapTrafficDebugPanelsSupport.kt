...
import com.trust3.xcpro.map.ADSB_ERROR_CIRCUIT_BREAKER_OPEN
import com.trust3.xcpro.map.ADSB_ERROR_CIRCUIT_BREAKER_PROBE
...
import com.trust3.xcpro.map.OgnConnectionIssue
import com.trust3.xcpro.map.AdsbTrafficSnapshot
import com.trust3.xcpro.map.OgnConnectionState
import com.trust3.xcpro.map.backoffRetryAfterSec
import com.trust3.xcpro.map.isActive
import com.trust3.xcpro.map.isBackingOff
import com.trust3.xcpro.map.isDisabled
