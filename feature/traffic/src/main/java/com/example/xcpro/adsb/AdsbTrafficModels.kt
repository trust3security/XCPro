...
const val ADSB_ERROR_CIRCUIT_BREAKER_OPEN = "ADS-B paused after repeated failures"
const val ADSB_ERROR_CIRCUIT_BREAKER_PROBE = "ADS-B retry probe in progress"
