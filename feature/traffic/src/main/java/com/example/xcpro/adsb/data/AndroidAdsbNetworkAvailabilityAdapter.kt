package com.example.xcpro.adsb.data
...
@Singleton
class AndroidAdsbNetworkAvailabilityAdapter @Inject constructor(
    @ApplicationContext context: Context
) : AdsbNetworkAvailabilityPort {

    private val connectivityManager = context.getSystemService(ConnectivityManager::class.java)
    private val tracker = AdsbNetworkAvailabilityTracker()
    ...
    init {
        ...
        if (manager == null) {
            ...
            runCatching {
                ...
                // Fail-open if callback registration is unavailable for this runtime.
                tracker.onRegistrationFailure()
            }
        }
    }
