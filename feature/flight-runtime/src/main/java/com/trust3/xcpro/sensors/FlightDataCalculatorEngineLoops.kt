...
internal fun FlightDataCalculatorEngine.updateVarioFilter(baro: BaroData?, accel: AccelData?) {
    ...
    val varioResult = com.trust3.xcpro.core.flight.filters.ModernVarioResult(
    ...
    if (shouldEmit) {
        ...
        cachedGPS?.let { gps ->
            emitter.emit(
                ...
                externalAirspeedSample = latestAirspeedSample,
                externalInstrumentSnapshot = latestExternalInstrumentSnapshot,
                externalFlightSettingsSnapshot = latestExternalFlightSettingsSnapshot,
...
internal fun FlightDataCalculatorEngine.updateGPSData(gps: GPSData?, compass: CompassData?) {
    ...
    if (!baroFresh) {
        ...
        val varioResultInput = cachedVarioResult ?: com.trust3.xcpro.core.flight.filters.ModernVarioResult(
