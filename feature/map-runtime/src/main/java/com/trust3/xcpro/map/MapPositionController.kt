...
class MapPositionController(
    ...
    companion object {
        ...
        private const val FOLLOW_CAMERA_ANIMATION_FALLBACK_MS = 250
    }
    ...
    fun updateOverlay(
        ...
        mapBearing: Double,
        orientationMode: com.trust3.xcpro.common.orientation.MapOrientationMode,
        speedMs: Double,
        nowMs: Long,
        frameId: Long? = null
    ) {
        ...
        locationOverlayPort.updateBlueLocation(
            location,
            clampedBearing,
            iconHeading,
            mapBearing,
    ...
    fun updateCamera(
        ...
        when (motion) {
            MapFollowCameraMotion.ANIMATE -> {
                camera.animateCamera(newCameraPosition, FOLLOW_CAMERA_ANIMATION_FALLBACK_MS)
            }
            MapFollowCameraMotion.MOVE -> {
