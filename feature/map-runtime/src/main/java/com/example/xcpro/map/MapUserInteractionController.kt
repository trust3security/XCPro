...
class MapUserInteractionController(
    ...
    fun showReturnButton() {
        ...
        AppLogger.dRateLimited(logTag, "show_return_button", 2_000L) {
            "Return button shown due to user interaction"
        }
    }
        ...
        cameraController.animateCamera(
            ...
            callback = object : MapCameraController.CancelableCallback {
                override fun onFinish() {
                    ...
                    AppLogger.d(logTag, "Returned to saved position")
                }

                override fun onCancel() {
                    isTrackingLocation = true
                    AppLogger.d(logTag, "Return animation canceled")
                }
            }
        )
        return true
    ...
    fun recenterOnCurrentLocation() {
        ...
        cameraController.setPadding(padding[0], padding[1], padding[2], padding[3])
        showRecenterButton = false
        AppLogger.d(logTag, "Recentered to current location")
    }
