...
internal enum class RacingAltitudeReference {
    MSL,
    QNH;
...
internal data class RacingPevCustomParams(
...
internal data class RacingStartCustomParams(
...
internal data class RacingFinishCustomParams(
