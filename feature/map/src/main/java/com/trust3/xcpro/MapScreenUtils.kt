...
internal fun convertToRealTimeFlightData(
    ...
    return RealTimeFlightData(
        ...
        externalMacCreadyActive = completeData.externalMacCreadyActive,
        externalQnhActive = completeData.externalQnhActive,
        bugsPercent = completeData.bugsPercent,
        bugsValid = completeData.bugsValid,
        ballastOverloadFactor = completeData.ballastOverloadFactor,
        ballastFactorValid = completeData.ballastFactorValid,
        outsideAirTemperatureC = completeData.outsideAirTemperatureC,
        outsideAirTemperatureValid = completeData.outsideAirTemperatureValid,
