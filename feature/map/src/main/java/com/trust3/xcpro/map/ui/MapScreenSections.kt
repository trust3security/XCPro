...
import com.trust3.xcpro.tasks.TaskMapOverlay
...
fun QnhDialog(
    ...
    qnhInput: String,
    qnhError: String?,
    unitsPreferences: com.trust3.xcpro.common.units.UnitsPreferences,
    ...
    val pressureDecimals = com.trust3.xcpro.pressurePrecision(unitsPreferences)
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                liveData?.let { data ->
                    ...
                    Text("Current: ${com.trust3.xcpro.formatQnhDisplay(data.qnh, unitsPreferences, pressureDecimals)} ($status)")
                    data.baroGpsDelta?.let { delta ->
                        Text("Baro vs GPS: ${com.trust3.xcpro.formatBaroGpsDelta(delta, unitsPreferences)}")
                    }
