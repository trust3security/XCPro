...
private data class OgnTrafficTargetRenderSignature(
    ...
    val addressType: com.trust3.xcpro.ogn.OgnAddressType
)
...
private data class AdsbTrafficTargetRenderSignature(
    ...
    val category: Int?,
    val proximityTier: com.trust3.xcpro.adsb.AdsbProximityTier,
    val proximityReason: com.trust3.xcpro.adsb.AdsbProximityReason,
    val isClosing: Boolean,
    val closingRateMps: Double?,
    val isEmergencyCollisionRisk: Boolean,
    val isEmergencyAudioEligible: Boolean,
    val emergencyAudioIneligibilityReason: com.trust3.xcpro.adsb.AdsbEmergencyAudioIneligibilityReason?,
    ...
    val positionFreshnessSource: com.trust3.xcpro.adsb.AdsbPositionFreshnessSource
)
