...
import com.trust3.xcpro.tasks.aat.calculations.AATSpeedCalculator
import com.trust3.xcpro.tasks.aat.models.AATFlightStatus
...
class AATTaskCalculator(
    ...
    fun calculateDistanceToTargetPointMeters(
        ...
        return com.trust3.xcpro.tasks.aat.calculations.AATMathUtils.calculateDistanceMeters(
            gpsLat,
            gpsLon,
            targetLat,
            targetLon
