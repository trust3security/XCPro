package com.trust3.xcpro.tasks.aat.persistence

import android.content.Context
import android.content.SharedPreferences
import com.trust3.xcpro.tasks.CupFormatUtils
import com.trust3.xcpro.tasks.LegacyCupStorageCleanupPolicy
        ...
        return try {
            ...
            parsedWaypoints.mapIndexed { index, waypoint ->
                val role = when (
                    ...
                    com.trust3.xcpro.tasks.core.WaypointRole.START -> AATWaypointRole.START
                    com.trust3.xcpro.tasks.core.WaypointRole.FINISH -> AATWaypointRole.FINISH
                    com.trust3.xcpro.tasks.core.WaypointRole.TURNPOINT,
                    com.trust3.xcpro.tasks.core.WaypointRole.OPTIONAL -> AATWaypointRole.TURNPOINT
                }
