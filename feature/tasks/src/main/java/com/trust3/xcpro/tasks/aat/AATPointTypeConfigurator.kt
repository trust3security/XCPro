    ...
    fun updateWaypointPointType(
        ...
        val newAssignedArea = if (waypoint.role == AATWaypointRole.TURNPOINT && update.turnType != null) {
            when (update.turnType) {
                com.trust3.xcpro.tasks.aat.models.AATTurnPointType.AAT_CYLINDER -> {
                ...
                com.trust3.xcpro.tasks.aat.models.AATTurnPointType.AAT_SECTOR -> {
                ...
                com.trust3.xcpro.tasks.aat.models.AATTurnPointType.AAT_KEYHOLE -> {
