...
internal fun resolveNavigationAltitudeMeters(
    fix: RacingNavigationFix,
    reference: com.trust3.xcpro.tasks.core.RacingAltitudeReference
): Double? {
    return when (reference) {
        com.trust3.xcpro.tasks.core.RacingAltitudeReference.MSL -> fix.altitudeMslMeters
        com.trust3.xcpro.tasks.core.RacingAltitudeReference.QNH -> fix.altitudeQnhMeters ?: fix.altitudeMslMeters
    }
}
