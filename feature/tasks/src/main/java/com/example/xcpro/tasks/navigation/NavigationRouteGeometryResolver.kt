...
import com.example.xcpro.tasks.racing.boundary.RacingBoundaryCrossingMath
...
import com.example.xcpro.tasks.racing.turnpoints.KeyholeGeometry
...
private fun resolveBoundaryAwareRoutePoint(
    ...
    val resolvedPoint = when (waypoint.role) {
        com.example.xcpro.tasks.racing.models.RacingWaypointRole.FINISH -> resolveFinishTouchPoint(
...
private fun resolveCylinderIntersection(
    ...
    val t = RacingBoundaryCrossingMath.intersectionParameter(
        ...
        transition = com.example.xcpro.tasks.racing.boundary.RacingBoundaryTransition.ENTER
    ) ?: return null
...
private fun fallbackCylinderTouchPoint(
    ...
    val point = com.example.xcpro.tasks.racing.turnpoints.CylinderCalculator()
...
private fun RacingBoundaryPoint.toSyntheticWaypoint(id: String): RacingWaypoint =
    RacingWaypoint.createWithStandardizedDefaults(
        ...
        lat = lat,
        lon = lon,
        role = com.example.xcpro.tasks.racing.models.RacingWaypointRole.TURNPOINT,
