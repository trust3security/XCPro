...
fun FlightModeIndicator(
    currentMode: com.trust3.xcpro.common.flight.FlightMode,
    onModeChange: (com.trust3.xcpro.common.flight.FlightMode) -> Unit,
    modifier: Modifier = Modifier,
    availableModes: List<com.trust3.xcpro.common.flight.FlightMode> =
        com.trust3.xcpro.common.flight.FlightMode.values().toList(),
    ...
    LaunchedEffect(currentMode, visibleModes) {
        if (currentMode !in visibleModes) {
            onModeChange(com.trust3.xcpro.common.flight.FlightMode.CRUISE)
        }
    }
